...
Testataan kirjautumisen merkkisyötteen oikeellisuuden tarkistusta ikä kentälle
...
Askel ja odotettu tulos
 ...
 1. Syötetään ikä kenttään ikä, joka sisältää aakkosia
 2. Täytetään muut kentät oikein
 3. Painetaan kirjautumis nappia
 4. Palvelu näyttää virheilmoituksen
 5. Virhe ilmoius kertoo, että ikä kentässä on kielettyjä merkkejä
