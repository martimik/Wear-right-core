...
IT:llä on oikeus käyttää projektin tuotoksia rajoitetusti opetustarkoituksiin.
IT:llä on oikeus käyttää Projektia referenssinään. Ryhmään kuuluvalla opiskelijalla on oikeus halutessaan käyttää Projektia referenssinään ja oikeudet lähdekoodiin. Kussakin Projektissa sovitaan erikseen, millä tavoin opiskelija voi hyödyntää projektissa tekemiään tuotoksia omissa projekteissaan.

5 AINEETTOMAT OIKEUDET

Projektissa mahdollisesti syntyvät keksinnöt, tekijänoikeuden suojaamat teokset tai 
muiden aineettomien oikeuksien suojaamat aineettomat oikeudet kuuluvat projektiryhmälle, 
pois lukien kohdassa 4 olevat poikkeukset. 

6 OIKEUS MATERIAALIIN JA AINEISTOON

Oikeudet materiaaliin ja aineistoon jäävät projektiryhmälle.
...
Jyväskylässä 21.2.2019 


Toimeksiantaja Wear-Right 

______________________________
Marja-Leena Tenhunen

Ryhmä-B Hydralist
Projektipäällikkö koko projektiryhmän puolesta
